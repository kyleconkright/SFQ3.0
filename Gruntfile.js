  	...
  	grunt.initConfig({
        ...
        coffee: {
     	...
     	uglify: {
      		my_target: {
      		    files: {
      		    	'soundfreaq-theme-7783581/assets/script.js.liquid': ['lib/vendor/jquery.js','lib/vendor/shopify.api.jquery.js','lib/vendor/cookie.js', 'lib/vendor/magnific.js','lib/vendor/gallery.js','lib/vendor/slides.js','lib/vendor/scrollfix.js','tmp/script.js'],
      		    }
      		}
	    },
	    watch: {
